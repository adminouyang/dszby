...
with open('py/GTJM/2.txt', 'r', encoding='utf-8') as file:
    ...
    with open('py/GTJM/网络收集.txt', 'w', encoding='utf-8') as outfile:
        for line in lines:
            # 首先检查行是否包含任何提取关键词
...
############################################ 假设要打开的文本文件名为*.txt
with open('py/GTJM/网络收集.txt', 'r', encoding='utf-8') as f:
    content1 = f.read()
...
with open('py/GTJM/网络收集.txt', 'w', encoding='utf-8') as f:
...
if __name__ == "__main__":
    input_file_path = 'py/GTJM/网络收集.txt'
    output_file_path = "py/GTJM/网络收集.txt"
...
with open('py/GTJM/网络收集.txt', 'r', encoding='utf-8') as file:
    lines = file.readlines()
# 创建新文件并写入替换后的内容
with open('py/GTJM/网络收集.txt', 'w', encoding='utf-8') as new_file:
    for line in lines:
        for old, new in replacements.items():
...
def write_list(file_path, data_list):
    with open(file_path, 'w', encoding='utf-8') as file:
        for item in data_list:
            file.write(item + '\n')
if __name__ == "__main__":
    input_file_path = "py/GTJM/网络收集.txt"  # 替换为你的输入文件路径
    output_file_path = "py/GTJM/网络收集.txt"  # 替换为你的输出文件路径
...
for line in fileinput.input("py/GTJM/网络收集.txt", inplace=True):   #打开临时文件原地替换关键字
...
def append_text_between_files(file1_path, file2_path):
    ...
    with open(file2_path, 'w', encoding='utf-8') as file2:
        file2.write('\n'.join(combined_lines))
file_path1 = 'py/GTJM/网络收集.txt'
file_path2 = 'py/测绘站采集/综合源.txt'
...
def remove_duplicates(input_file, output_file):
    ...
    print("去重后的行数：", len(output_lines))
# 使用方法
remove_duplicates('py/测绘站采集/综合源.txt', 'py/测绘站采集/综合源.txt')
...
# 将txt文件转换为m3u文件
txt_to_m3u('py/测绘站采集/综合源.txt', 'py/测绘站采集/综合源.m3u')
txt_to_m3u('py/测绘站采集/组播优选.txt', 'py/测绘站采集/组播优选.m3u')
txt_to_m3u('py/GTJM/网络收集.txt', 'py/GTJM/网络收集.m3u')
